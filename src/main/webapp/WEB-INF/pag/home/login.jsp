...
<html>
		...
		<div class="login-banner">
            ...
            <div class="login-links">
                <label for="remember-me"><input id="remember-me" type="checkbox">记住密码</label>
								...
								<a href="/Page/toRegister.do" class="zcnext am-fr am-btn-default">注册</a>
								<br />
            </div>
								<div class="am-cf">
	...
	<script type="text/javascript">
	  ...
	  function callback(ajaxDAO,status){
		  if(ajaxDAO.success){
			  window.location.href= ajaxDAO.data||"/catalog/home.do";
			  /*注意这里的页面跳转用或运算,原因是为了返回之前被拦截的请求地址,这里需要注意的一点就是 必须将 被拦截的地址放在前面 ,因为只有前面的拦截地址为空 才跳转默认地址*/
		  }
		  else{
